...
class DispatchService {
  ...
  registerRider(socketId, riderData) {
    ...
    const riderState = {
      ...
      avatarUrl: riderData.avatarUrl || riderData.photoUrl || (existing ? existing.avatarUrl : null),
      photoUrl: riderData.photoUrl || riderData.avatarUrl || (existing ? existing.photoUrl : null),
